...
public abstract class GameState {
	...
	/**
	 * Called when the game loads, initializes objects such as font,
	 * backgrounds, entities, etc.
	 */
	...
	/**
	 * Sets the game state by unloading the current state and loading the new
	 * one
	 * 
	 * @param currentState
	 * @param newState
